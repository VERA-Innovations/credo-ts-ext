...
export const getDrizzleDatabaseConfig = (args: any): Pick<DrizzleStorageModuleConfig, 'database'> => {
    const dbUrl = args['drizzle-storage-db-url']
    const drizzleDBType = args['drizzle-storage-type']
    console.log("This is dbUrl", dbUrl)
    console.log("This is drizzleDBType", drizzleDBType)
